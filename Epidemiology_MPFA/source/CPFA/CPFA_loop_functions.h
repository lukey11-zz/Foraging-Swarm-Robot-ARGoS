...
class CPFA_loop_functions : public argos::CLoopFunctions
{
	...
	public:
        ...
        void InitInfectedFood(int num); //qilu 05/07/2021
        void UpdateFoodStatus(); //qilu 05/11/2021
  ...
  vector<CCylinderEntity> Cylinders; //qilu 10/18/2016
        ...
        std::vector<int> FoodStatus;
        std::vector<argos::Real> FoodTimer;//qilu 05/10/2021
